...
>
    <span class="inline-flex items-center px-3 rounded-l-md border border-r-0 dark:border-gray-600 border-gray-300 dark:bg-gray-900 bg-gray-50 dark:text-gray-400 text-gray-500 sm:text-sm">
        <svg class="h-5 w-5 dark:text-gray-200 text-gray-400" fill="currentColor" viewBox="0 0 20 20">
    ...
    <input
        ...
        x-bind:value="value"
        type="text"
        class="rounded-none dark:bg-gray-900 dark:border-gray-600 border-gray-300 rounded-r-md flex-1 form-input block w-full transition duration-150 ease-in-out sm:text-sm sm:leading-5"
    />
</div>
